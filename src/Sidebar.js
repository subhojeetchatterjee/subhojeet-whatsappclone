          ...
          <div className="siderbar__wrapper">
            ...
            <div className="sidebar__header">
              ...
              <p className="sidebar__greeting mobile__tag">
                {" "}
                <a
                  href="https://github.com/subhojeetchatterjee/"
                  style={{ color: "white" }}
                >
                  Made with ♥ by <span style={{ color: "white" }}>Subhojeet Chatterjee</span>
                </a>
              </p>
        ...
        <div className={"sidebar"}>
          <div className="sidebar__header">
            ...
            <p className="sidebar__greeting">
              {" "}
              <a href="https://github.com/subhojeetchatterjee/">
                Made with ♥ by <span style={{ color: "blue" }}>Subhojeet Chatterjee</span>
              </a>
            </p>
            <div className="sidebar__headerRight">
              <IconButton>
